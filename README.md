...
2. If you want to log in as an admin user use the below credentials.
 **Email**: addis0132@gmail.com
 **pass**: abel1234
3.  Now you can create packages and assign roles for customers read the API documentation to check all user type permissions.
